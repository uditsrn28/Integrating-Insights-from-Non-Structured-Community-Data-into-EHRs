module.exports = function (record, dbToRecordNames) {
    return {
        ...
        name: "Diabetes Management Org", // Description of service as presented to a consumer while searching
        ...
        programName: ["Diabetes management"], // Program Names that categorize the service
        // characteristic: [{
        //     coding: [
        //         {
        //             display: String
